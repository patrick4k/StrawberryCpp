...
public class TParser extends Parser {
	...
	public static class ScriptContext extends ParserRuleContext {
		...
		public List<TerminalNode> Nl() { return getTokens(TParser.Nl); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TParserListener ) ((TParserListener)listener).enterScript(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TParserListener ) ((TParserListener)listener).exitScript(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TParserVisitor ) return ((TParserVisitor<? extends T>)visitor).visitScript(this);
	...
	public static class NumberListContext extends ParserRuleContext {
		public List<TerminalNode> Number() { return getTokens(TParser.Number); }
		public TerminalNode Number(int i) {
			return getToken(TParser.Number, i);
		}
		public List<TerminalNode> Sarrow() { return getTokens(TParser.Sarrow); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TParserListener ) ((TParserListener)listener).enterNumberList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TParserListener ) ((TParserListener)listener).exitNumberList(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TParserVisitor ) return ((TParserVisitor<? extends T>)visitor).visitNumberList(this);
			else return visitor.visitChildren(this);
		}
	}
