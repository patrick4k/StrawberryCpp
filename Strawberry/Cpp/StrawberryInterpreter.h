...
public:
    ...
    std::any visitLoopOnScopeOnExpr(StrawberryParser::LoopOnScopeOnExprContext *ctx) override;
    std::any visitLoopOnScopeOnArgs(StrawberryParser::LoopOnScopeOnArgsContext *ctx) override;
    std::any visitLoopOnBodyOnExpr(StrawberryParser::LoopOnBodyOnExprContext *ctx) override;
    std::any visitLoopOnBodyOnArgs(StrawberryParser::LoopOnBodyOnArgsContext *ctx) override;
