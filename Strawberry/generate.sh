...
LOCATION=/home/patrick/antlr4/antlr-4.12.0-complete.jar
java -jar $LOCATION -Dlanguage=Cpp -listener -visitor -o generated/ -package antlrcpptest StrawberryLexer.g4 StrawberryParser.g4
#java -jar $LOCATION -Dlanguage=StrawberryCpp -listener -visitor -o generated/ -package antlrcpptest -XdbgST StrawberryLexer.g4 StrawberryParser.g4
#java -jar $LOCATION -Dlanguage=Java -listener -visitor -o generated/ -package antlrcpptest StrawberryLexer.g4 StrawberryParser.g4
