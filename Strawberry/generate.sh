...
#java -jar $LOCATION -Dlanguage=StrawberryCpp -listener -visitor -o generated/ -package antlrcpptest TLexer.g4 TParser.g4
#java -jar $LOCATION -Dlanguage=StrawberryCpp -listener -visitor -o generated/ -package antlrcpptest -XdbgST TLexer.g4 TParser.g4
...
#java -cp $CLASSPATH org.antlr.v4.Tool -Dlanguage=StrawberryCpp -listener -visitor -o generated/ -package antlrcpptest -XdbgST TLexer.g4 TParser.g4
