...
java -jar %LOCATION% -Dlanguage=Cpp -listener -visitor -o generated/ -package strawberrycpp TLexer.g4 TParser.g4
::java -jar %LOCATION% -Dlanguage=Cpp -listener -visitor -o generated/ -package strawberrycpp -XdbgST TLexer.g4 TParser.g4
::java -jar %LOCATION% -Dlanguage=Java -listener -visitor -o generated/ -package strawberrycpp TLexer.g4 TParser.g4
